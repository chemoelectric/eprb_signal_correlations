...
\begin{abstract}
  ...
  derived by probability theory. There is no ``entanglement,'' and all
  causation is by contact-action.
\end{abstract}
...
state'' or any such verbally obfuscated stuff must always be simply
different notation for some probability expression, wave coherence
expression, or the like. The real reason anyone believes there is
magic involved seems not to be that the magic exists, but that the
Fathers of the early Quantum Church (although perhaps not the great
Emissary himself~\cite{enwiki:1174555777}) forbade treatment of
...
engineer). Peer review thus serves only to reinforce the
...
elite of journals. Eventually, the Nobel Prize in Physics for~2022 is
awarded to some of these quantum physicists, for their superlative
achievements in the pursuit of this
balderdash~\cite{enwiki:1169021780}.
...
scientific enterprise, just to be famous and also lumped in with
charlatans and insulted with a cash reward?
