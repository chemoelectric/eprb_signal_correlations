...
Colleges.\footnote{Even I, as an engineering student in the early
  ...
  {\em{commanded}} by my physics professor.} One is permitted
...
discovered long ago what we discovered above: that there actually
{\em{is no}} ``modern physics''---just ``classical physics'' that no
one has been allowed to investigate.
