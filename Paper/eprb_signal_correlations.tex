...
delta~$\delta(\phi_{02}-\phi_1)$, times whatever constant is necessary
to make the double integral of the joint pdf by itself come out
to~one. We do a double integration of~(\ref{rhoprime}), going twice
over the full 360~degrees of the circle.
...
\begin{equation}
\rho = \int_{0}^{\frac{\pi}{4}}\int_0^{2\pi}\cos(2\Delta\phi_2)\cos(2\theta)\,2\delta(\phi_{02}-\phi_1)\,d\phi_{02}\,d\theta
\end{equation}
if~$\theta\in[0,\frac{\pi}{4}]$,
\begin{equation}
...
\end{equation}
if~$\theta\in[\frac{3\pi}{4},\frac{5\pi}{4}]$,
\begin{equation}
-\rho = \int_{\frac{5\pi}{4}}^{\frac{7\pi}{4}}\int_0^{2\pi}\cos(2\Delta\phi_2)\cos(2\theta)\,\delta(\phi_{02}-\phi_1)\,d\phi_{02}\,d\theta
\end{equation}
if~$\theta\in[\frac{5\pi}{4},\frac{7\pi}{4}]$, and
\begin{equation}
\rho = \int_{\frac{7\pi}{4}}^{2\pi}\int_0^{2\pi}\cos(2\Delta\phi_2)\cos(2\theta)\,2\delta(\phi_{02}-\phi_1)\,d\phi_{02}\,d\theta
\end{equation}
if~$\theta\in[\frac{7\pi}{4},2\pi]$.
...
all~$\phi_1,\phi_2\in\Re$, and the result accords with quantum mechanics.
