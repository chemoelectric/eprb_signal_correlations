...
centers.\footnote{Even I, as an engineering student in the early
  1980s, encountered what apparently was a common practice in
  approximately the 1970s: the professor would raise their voice and
  boom: ``{\em{Do {\em{not}} try to understand quantum mechanics! Just
      do the calculations!}}'' This was an actual {\em{command}}. I
  have never forgotten the effect this had on me, to be
  {\em{commanded}} by my physics professor---especially given he was
  by far the best teacher I ever had.} One is permitted {\em{only}} to
...
what we discovered above: that there actually {\em{is no}} ``modern
physics''---just ``classical physics'' that no one has been allowed to
investigate.
