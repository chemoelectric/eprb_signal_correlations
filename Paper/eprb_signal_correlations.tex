...
to make the double integral of the joint pdf itself come out
to~one. We do a double integration of~(\ref{rhoprime}), both integrals
going from a point on the protractor to another.
