...
\insert\footins{%
  ...
  A special thanks to~P. for a number of things.}
...
{\bf{This paper is now deprecated in favor of a much simpler proof.}}
Given an expression of the form
$\rho=\cos(2\phi_{01})\cos(2\phi_{02})$, one can take the case
$\phi_{02}=0$, giving $\rho=\cos(2(\phi_{01}-\phi_{02}))$. Then add
any angle $\Delta\phi$ to both $\phi_{01}$ and~$\phi_{02}$, giving
$\rho=\cos(2((\phi_{01}+\Delta\phi)-(\phi_{02}+\Delta\phi)))$. Introduce
the names $\phi_1=\phi_{01}+\Delta\phi$
and~$\phi_2=\phi_{02}+\Delta\phi$. Then
$\rho=\cos(2(\phi_1-\phi_2))$. \par This proof is so simple, and so
unshakeable as proof that quantum mechanics is really classical
physics plus foppery, one wonders how many times it was deliberately
suppressed.
...
substituting~$\theta=\Delta\phi_1$ and letting it be~$\theta$ that
runs from~zero to~$2\pi$. Thus
\begin{multline}
...
cult indoctrination centers.\footnote{As an engineering student in the
  ...
  this, to my eternal pain. What was this hatred of Einstein in
  relation to quantum mechanics? It was a doctrinal hatred. Early
  Christian mockery of heretics is similar.} One is permitted
