...
results. Yet experimentalists report positive results. Therefore not
only is the inequality itself a failure of the scientific method, so
must be the experiments.
