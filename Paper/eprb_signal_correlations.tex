...
{\bf{THE FOLLOWING REALLY COULD USE REVISION. IT DOES NOT SEEM
    ...
    REPRESENTATION. MIND YOU, THE SOLUTION IS CORRECT OR QUANTUM
    MECHANICS WOULD BE WRONG (unlike physicists, I require that
    mathematics be consistent) AND THE SIMULATIONS WOULD NOT WORK. I
    MEAN THAT I AM TRYING TO WRITE COORDINATE-FREE ARGUMENTS IN
    COORDINATE-UNFREE NOTATIONS, AND NOT GETTING IT QUITE RIGHT.}}
