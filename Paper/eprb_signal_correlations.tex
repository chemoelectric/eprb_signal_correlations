...
The choice of values for the elements of $T'$ makes it so the standard
deviations in (\ref{corrcoef}) equal one, and thus the correlation
coefficient simplifies to the covariance
\begin{equation}
  \rho = E(\tau'_1 \tau'_2)
\end{equation}
...
time on what this angular origin~$\phi_1$ will be, and so the
