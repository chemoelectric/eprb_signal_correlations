...
substituting~$\theta=\Delta\phi_1 $. {\bf{FIXME: Bounds of integration
    for $\theta$ would differ in a trivial way. Try to make this so a
    mathematician would not nitpick.}} Thus
\begin{multline}
