...
# had derived the correlation coefficient from classical physics
# alone, by using electromagnetic wave theory. I, however, wanted a
...
# that of quantum mechanics. But in the experiment both settings are
# changed. Therefore the inequality is invalid.
#
# What one must do is introduce a ‘landmark’ or ‘origin’ for the each
# of the two angular settings, and let it be an unknown in
# [0,2π]. Then a very simple joint probability density function has to
# be defined and used to weight the CHSH solution, and a set of double
